...
9. Добавить импорт компоненты футера  и селектор в рутовую компоненту, показать,
...
Добавить роут для отображения компоненты списка девайсов, показать, что компонента отображается.
```
...
18. Заменить компоненту в app.routes, показать, что компоеннта детальной инфы работает.
